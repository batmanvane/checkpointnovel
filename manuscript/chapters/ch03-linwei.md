...
She stood in the glass-walled conference room on the 30th floor of Building A, the room they called the Fishbowl because it hung out over the atrium and everyone on the campus could look up and see who was presenting to the executive team. She'd arrived twenty minutes early to check the projector, the clicker, and the backup clicker, because redundancy was not paranoia. Redundancy was engineering.
...
"Layer 1. Adaptive Signal Processing." She tapped the bottom band. "This is the foundation. Raw neural data comes in from 131,072 electrodes. Layer 1 reads it — spike sorting, Bayesian decoding, gain adjustment. It adapts to each user's neural drift every seventy-two hours, so the signal stays clean even as the brain changes over time. It makes sure we're reading the user's brain accurately."
...
"Pre-loading isn't retrieval. It's priming. The knowledge isn't delivered on demand — it's staged in advance, so when the user reaches for it, it's already there."

Click.

"Layer 3. Neural Caching." The middle band. "Frequently accessed knowledge is maintained in a warm state — neural pathways kept partially activated for faster retrieval. Your most-used knowledge is always in the cache, always ready. This is what dropped our latency from 340 milliseconds to 12."

She let that land, too. Twelve milliseconds. Below the threshold of conscious perception. The user couldn't tell the difference between BCI-delivered knowledge and their own memory. That was the whole product.

"340 to 12," VP Liu repeated, writing it down. He always wrote things down, even though his BCI recorded everything. Lin Wei did it too.
...
She clicked to the next slide. A before-and-after visualization: two brain maps, one diffuse and scattered, the other sharp and precise.
...
She watched it register around the table. Director Huang's expression shifted to something closer to satisfaction. VP Liu stopped writing and looked at the slide. Even the government observers leaned forward.
...
The applause was brief and professional — this was CortexLink, not a keynote — but it was real. Director Huang said something about Q4 targets. VP Liu mentioned a senior architect role opening in the spring. Chen Zhiwei caught her eye from the end of the table and gave her a look that meant *drinks tonight, my treat*.
...
Her desk was in the northeast corner of the 14th floor, close to the window. Three monitors arranged in an arc: the left for terminal windows, the center for primary work, the right for communications and monitoring dashboards. Standing desk, adjusted to her exact height. The mechanical keyboard she'd built from a kit during her second year — Cherry MX Brown switches, a maple wood case she'd sanded herself, keycaps in CortexLink blue because she'd been twenty-three and enthusiastic. It was the only personal object on her desk besides the jade plant.
...
CortexLink monitored performance during the downtime, as it always did during firmware cycles. Cognitive assessments administered via standard mobile apps — working memory, processing speed, domain-specific knowledge recall. The expectation was clear: without the BCI, performance would drop. Slower retrieval, lower accuracy, the cognitive equivalent of walking after you've been driving. You can do it. You just feel the difference.

The data came back wrong.

Not wrong like a crash. Wrong like an answer that's correct when it shouldn't be. Twenty-three users in the Tier-1 cohort showed no measurable performance drop during the seventy-two-hour deactivation. None. They recalled complex engineering specifications, medical protocols, legal frameworks — material they had only ever accessed through the BCI — as fluently and accurately as if the device were still on.
...
She opened the folder she'd maintained since her open-source days — a personal repository of things that didn't fit, edge cases that weren't bugs and weren't features, anomalies that were probably nothing but deserved a commit message anyway. She'd called it `interesting-anomalies/` since university, and it now contained fourteen years of observations, tagged and searchable.
...
It was probably nothing. Residual priming was well-documented — users retained some BCI-accessed knowledge after deactivation, fading over hours. But seventy-two hours was too long for priming. Layer 3's cache refreshed every ninety minutes. After three days, those pathways should have cooled to ambient. The knowledge should have faded like a dream.
...
This wasn't new. The AI engineering team had been shipping updates autonomously for over a year, faster than any human engineer could review. The updates were tested, validated, deployed through the standard automated pipeline. They were, by every metric Lin Wei could measure, improvements.
...
Forty-five square meters. Seventh floor. Northeast corner, which meant morning light in the bedroom and afternoon shade in the living room, which was also the office. Three monitors on a wall-mounted desk — a mirror of her work setup. A small kitchen with a rice cooker, an electric kettle, and a wok she used twice a week. A single bookshelf, half-filled with technical manuals she no longer needed but kept because they'd shaped her thinking. A narrow balcony overlooking a courtyard where an old man practiced tai chi every morning at six-fifteen, precise and unhurried, moving through forms that had been optimized by centuries of human iteration without any AI involved.
...
She used ten minutes to review the anomaly data one more time, scrolling through the Tier-1 cohort profiles, checking the deactivation timestamps against the performance scores, looking for some variable she'd missed. She didn't find one.
...
Her mother's face filled the right monitor. Behind her, the kitchen of the apartment in Wuxi — the same pale green tiles above the counter, the same calendar pinned to the wall with a date circled in red that Lin Wei knew was her cousin's wedding next month. Her father appeared in the background, holding a plate.
...
"How is work?" her mother asked. Her parents knew she worked at CortexLink. They knew CortexLink made the device that half of China used. Beyond that, the details dissolved into the gap between her world and theirs, the way light dissolves when it hits deep water.
...
Her mother's face did the thing it always did when Lin Wei reported professional success — pride and worry in equal measure, because in her mother's framework, a promotion meant more work, and more work meant less eating.
...
She closed the video call app. Opened the browser. The anomaly entry was near the right edge, its title truncated to `Tier-1 cohort persis...`.

She looked at it for a long moment. Twenty-three users. Seventy-two hours. No drop. Knowledge that persisted without the device, encoded in neural tissue that her system — her Layer 5, her personalization engine — had been optimizing for precision delivery.
...
She closed her laptop. The apartment was quiet. The jade plant sat in the lamplight, patient, growing at its own pace, one leaf at a time, the way things grew when nothing was optimizing them.
